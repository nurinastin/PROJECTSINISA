...
if(isset($_POST["reset_pass"])){
    ...
    $emailTo = mysqli_real_escape_string($host, $_POST["email_reset"]); //email kamu atau email penerima link reset
    $code = uniqid(true); //Untuk kode atau parameter acak

    session_start();
    $_SESSION["code"] = "$code";

    $query = mysqli_query($host, "INSERT INTO lupa_password VALUES ('','$emailTo','$code')");
    ...
    try {
        ...
        $mail->setFrom("nurinastin@gmail.com", "SINISA"); //email pengirim
        ...
        echo "
            ...
            window.location.href = 'forgot-password-alert.php';
            </script>
        ";
