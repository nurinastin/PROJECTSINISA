          ...
          <div class="row">
            <div class="col-md-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  <center>
                  <p class="card-title"><h3>JADWAL PENYULUHAN ADMIN</h3></p>
                </center>

                <div class="row"> <!--membuat wrap grup kolom horizontal-->
                 <a href="jadwal_penyuluhan_admin.php" type=button-block class="btn btn-primary btn-block">Jadwal Penyuluhan</a> <!--wes wor-->
